...
#    newer version exists' et ne chargeait pas le plugin proprement.
...
#    sauf le fichier canonique 'MiSideCoop.dll'. Évite que d'anciennes versions
#    laissées avec un suffixe (ex: MiSideCoop_v1.3.3.dll, MiSideCoop.dll.bak)
#    soient chargées en double par BepInEx.
