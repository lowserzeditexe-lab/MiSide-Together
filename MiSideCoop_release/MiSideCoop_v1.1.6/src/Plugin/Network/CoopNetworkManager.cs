...
namespace MiSideCoop.Network
{
    ...
    public class CoopNetworkManager : MonoBehaviour
    {
        ...
        private void SpawnPlayer1Local()
        {
            ...
            {
                MiSideCoopPlugin.Logger.LogError($"[Co-op] SpawnPlayer1Local échec : {ex.Message}");
            }
        }
        ...
        private void SpawnPlayer2Remote()
        {
            ...
            {
                MiSideCoopPlugin.Logger.LogError($"[Co-op] SpawnPlayer2Remote échec : {ex.Message}");
            }
        }
        ...
        private void SpawnPlayer2Local()
        {
            ...
            {
                MiSideCoopPlugin.Logger.LogError($"[Co-op] SpawnPlayer2Local échec : {ex.Message}");
            }
        }
        ...
        private void SpawnPlayer1Remote()
        {
            ...
            {
                MiSideCoopPlugin.Logger.LogError($"[Co-op] SpawnPlayer1Remote échec : {ex.Message}");
            }
        }
        ...
        {
            string[] names = { "MC", "Player", "PlayerController", "MainCharacter",
                                "PlayerCharacter", "male_mc", "Person" };
