...
namespace MiSideCoop.Network
{
    ...
    public class AvatarAnimatorSync : MonoBehaviour
    {
        ...
        public void Initialize(Animator animator)
        {
            ...
            try
            {
                // IL2CPP-safe : utiliser parameterCount + GetParameter(int),
                // car get_parameters() (qui retourne le tableau) est STRIPPÉ
                // dans le build MiSide.
            ...
            catch (Exception ex)
            {
                MiSideCoopPlugin.Logger?.LogWarning(
                    ...
                    "Falling back to best-effort mode (all candidates attempted).");
