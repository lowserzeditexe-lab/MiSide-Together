...
namespace MiSideCoop.Relay
{
    ...
    public class RoomManager : MonoBehaviour
    {
        ...
        private IEnumerator RegisterCoroutine(string code, System.Action<bool> callback)
        {
            ...
            // IL2CPP-safe : le constructeur UnityWebRequest(string, string) est
            // STRIPPÉ dans le build MiSide (constaté v1.1.4 :
            // "Method not found: 'Void UnityEngine.Networking.UnityWebRequest
            //  ..ctor(System.String, System.String)'").
            // On utilise UnityWebRequest.Put(url, byte[]) — factory qui survit
            // au stripping — puis on force la méthode à POST. Astuce IL2CPP
            // standard pour un POST avec corps binaire et content-type custom.
            using var req = UnityWebRequest.Put($"{relay}/register", body);
            req.method          = "POST";
