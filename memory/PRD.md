...
- **v1.5.0** — **Sync skins/vêtements + lancement simultané + bouton DÉMARRER (HOST + GUEST)** :
  ...
  - **Build** : 0 warnings, 0 errors. Release `/app/MiSideCoop_release/MiSideCoop_v1.5.0.zip` (128 KB, DLL 104 KB).
