...
namespace MiSideCoop.UI
{
    ...
    public class CoopMenuUI : MonoBehaviour
    {
        ...
        ///
        /// Note IL2CPP : la version générique Resources.FindObjectsOfTypeAll&lt;T&gt;()
        /// est strippée. On utilise l'overload non-générique avec Type.
        /// </summary>
        private static Font FindFont()
        {
            ...
            // Fallback : tente la ressource built-in (peut aussi être strippée mais tentons)
            try
            {
