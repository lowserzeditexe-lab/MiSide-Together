...
namespace MiSideCoop.UI
{
    ...
    public class CoopMenuUI : MonoBehaviour
    {
        ...
        {
            // Voie A : built-in Unity fonts (Arial d'abord, confirmé présent sur MiSide)
        ...
        /// <summary>
        /// Wrapper minimal autour de SetPixels32. Doit rester aussi simple que
        /// possible pour que SEULE cette méthode échoue au JIT en cas de
        /// MissingMethodException — pas son appelante.
        /// </summary>
